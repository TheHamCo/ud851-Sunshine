...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData(){
        ...
        URL weatherSearchUrl = NetworkUtils.buildUrl(preferredWeatherLocation);
    ...
    private class FetchWeatherTask extends AsyncTask<URL, Void, String> {
        ...
        protected String doInBackground(URL... urls) {
            String weatherJsonResults = null;
            try {
                weatherJsonResults = NetworkUtils.getResponseFromHttpUrl(urls[0]);
            } catch (IOException e) {
                e.printStackTrace();
            }
            return weatherJsonResults;
        }

        @Override
        protected void onPostExecute(String weatherJsonResults) {
           mWeatherTextView.setText(weatherJsonResults);
        }
    }
